    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (zodValid.success) {
            if (!search) {
                ...
                res.cookie('status', signedIn,{  domain:'.summarizer.shop',httpOnly:false, secure: true, sameSite: 'none',path:'/'});
                res.cookie('token', token,{  domain:'.summarizer.shop',httpOnly:false, secure: true, sameSite: 'none',path:'/'});
